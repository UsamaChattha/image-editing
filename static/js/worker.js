var hidden = false;
var contrast_adjusted = false;
var comic_applied = false;
var sharpen = false;
var sharpen_threshold = 0;
var sharpen_radius, sharpen_percentage;
...
function applySharpen() {
  ...
  var sharpen_percentage = percentage;
  var sharpen_radius = radius;
  var sharpen_threshold = threshold;
...
function adjustContrast() {
  request = new XMLHttpRequest
  request.open('POST', '/adjust_contrast')
  request.setRequestHeader('Content-Type', 'application/json; charset=UTF-8');

  request.send()
  var contrast_adjusted = true;
...
function resetEffect() {
  ...
  contrastInput.value = contrast.value;
  if (mod_image) {
    mod_image.style.transform = '';
    mod_image.style.filter = "";
  }

  norm_image.style.transform = '';
  norm_image.style.filter = '';
...
function submitEffect() {
  ...
  data = {
    ...
    'mirror': mirror,
    'invert': invert,
    'comic_applied': comic_applied,
    'sharpen': Boolean(sharpen_radius),
    'sharpen_radius': sharpen_radius,
    'sharpen_percentage': sharpen_percentage,
